		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Call Off Application",
									"targetURL": "#comsapmanagecalloffapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmanagecalloffapp-display": {
								"semanticObject": "comsapmanagecalloffapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.managecalloffapp",
									"url": sap.ui.require.toUrl("com/sap/managecalloffapp")
								}
							}
						}
					}
